...
const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    desc: "바삭한 매콤 치킨 패티",
    price: 6400,
    img: "https://images.unsplash.com/photo-1606756790138-261c36a7f7d8?q=80&w=1600&auto=format&fit=crop",
    category: "버거",
    options: [
      { label: "세트", choices: [
        { key: "single", label: "단품" },
  ...
  },
  {
    ...
    desc: "베이컨과 반숙 에그의 조화",
    price: 6800,
    img: "https://images.unsplash.com/photo-1551782450-17144c3a48e6?q=80&w=1600&auto=format&fit=crop",
    category: "버거",
    options: [
      { label: "세트", choices: [
        { key: "single", label: "단품" },
  ...
  },
  {
    ...
    desc: "한 입에 쏙",
    price: 2800,
    img: "https://images.unsplash.com/photo-1598124146163-9f69fc039105?q=80&w=1600&auto=format&fit=crop",
    category: "사이드",
  },
